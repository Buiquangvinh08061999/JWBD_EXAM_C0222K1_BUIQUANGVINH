    ...
    <form method="post">
        <fieldset class="row">
            ...
            <div class="col-sm-12 mt-3">
                ...
                <input type="date"  placeholder="Enter date of birth as DD/MM/YYYY"class="form-control" name="birth" required >
            </div>

            <div class="col-sm-12 mt-3">
                <label>Address</label>
                <input type="text" placeholder="Enter Addres" class="form-control" name="address" required>
            </div>
